...
# --- inputs ---
ADAPTER="${ADAPTER:-/workspace/output/swift_27b_788_view_7feats_improve/v0-*/swa_adapter}"
DPO_DATASET="${DPO_DATASET:-/workspace/data/dpo_view_7feats.jsonl}"
OUTPUT_DIR="${OUTPUT_DIR:-/workspace/output/swift_27b_788_view_7feats_improve_dpo}"
