...
#
# Key settings:
#   - 25 categories (14 feature + 11 view)
#   - max_length=6144 (increased for larger category set + longer outputs)
#   - LoRA rank=16 all-linear
#   - DeepSpeed Zero-3
...
TRAIN_DATASET="${TRAIN_DATASET:-/workspace/data/train_15feats_view.jsonl}"
VAL_DATASET="${VAL_DATASET:-/workspace/data/val_15feats_view.jsonl}"
OUTPUT_DIR="${OUTPUT_DIR:-/workspace/output/swift_27b_15feats_view}"
