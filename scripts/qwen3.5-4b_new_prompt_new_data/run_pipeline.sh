#!/bin/bash
# ================================================================
# Qwen3.5-4B ms-swift LoRA Pipeline — New Prompt + New Data
#
# PVC: qwf-workspace
# Data: IM_D03_PT_5k_Augmented.json → train/val JSONL with NEW prompt
# ================================================================
set -euo pipefail
...
echo "============================================="
echo " Qwen3.5-4B — New Prompt + New Data"
echo " Hardware: 1x GPU"
echo "============================================="

# ============ 0. Environment variables ============
export DATA_DIR="/workspace/finetune/data/data"
export OUTPUT_DIR="/workspace/finetune/output/swift_4b_newprompt"
...
# ============ 4. Prepare data ============
echo ""
echo ">>> [4/5] Preparing data with NEW prompt..."

TRAIN_FILE="$DATA_DIR/train_10feats_newprompt_4b.jsonl"
VAL_FILE="$DATA_DIR/val_10feats_newprompt_4b.jsonl"
BENCH_FILE="$DATA_DIR/benchmark_10feats_newprompt_4b.jsonl"
...
echo "    Prompt: NEW (structured 10-feature)"
