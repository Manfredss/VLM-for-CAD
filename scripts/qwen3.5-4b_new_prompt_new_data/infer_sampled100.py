#!/usr/bin/env python3
"""
Run inference on sampled 100 images using Qwen3.5-4B with NEW prompt.
Saves incrementally every 5 images.
"""
...
def main():
    ...
    parser.add_argument("--gt_json", required=True,
                        help="Ground truth JSON (5k_10feats_v2_sampled_100.json)")
    parser.add_argument("--image_dir", default="/workspace/data/5k")
    ...
    for i, rec in enumerate(records, 1):
        ...
        if i % 5 == 0 or i == len(records):
            ...
            print(f'  [incremental save] {i}/{len(records)} results written to {output_path}')
