#!/bin/bash
# ================================================================
# Qwen3.5-4B ms-swift LoRA Training — New Prompt + New Data
#
# Single GPU, no DeepSpeed needed.
# LoRA rank=32, alpha=64, all-linear, unfrozen ViT + Aligner
# ================================================================

SCRIPT_DIR="$(cd "$(dirname "$0")" && pwd)"
TRAIN_FILE="${TRAIN_FILE:-/workspace/finetune/data/data/train_10feats_newprompt_4b.jsonl}"
VAL_FILE="${VAL_FILE:-/workspace/finetune/data/data/val_10feats_newprompt_4b.jsonl}"
