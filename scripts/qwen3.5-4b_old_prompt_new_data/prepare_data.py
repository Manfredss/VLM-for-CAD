...
Data layout on qwf-workspace:
  /workspace/finetune/data/data/5k_10feats_v2_augmented.json
  /workspace/finetune/data/data/IM_D03_PT_5k_Augmented/  (images)
"""
...
# Load or build image sizes cache
...
if CACHE_PATH.exists():
    ...
    print("Building image sizes cache...")
...
# Write train JSONL
train_file = OUTPUT_DIR / "train_10feats_oldprompt_4b.jsonl"
...
# Write val JSONL
val_file = OUTPUT_DIR / "val_10feats_oldprompt_4b.jsonl"
...
bench_file = OUTPUT_DIR / "benchmark_10feats_oldprompt_4b.jsonl"
