#!/bin/bash
# ================================================================
# Qwen3.5-4B ms-swift LoRA 训练流水线 (增强数据版) — Nautilus
#
# 用法（在 Pod 内）:
#   bash /workspace/finetune/scripts/nautilus_4b/run_pipeline_4b_aug.sh
# ================================================================
set -euo pipefail
...
echo "============================================="
echo " Qwen3.5-4B ms-swift LoRA Pipeline (AUG)"
echo " Hardware: 1x A40 / A100"
echo "============================================="

# ============ 0. 环境变量 ============
export DATA_DIR="/workspace/finetune/data/data"
export OUTPUT_DIR="/workspace/finetune/output/swift_4b_aug"
...
# 增强数据集用 IM_D03_PT_5k_Augmented 目录
...
# ============ 5. 开始训练 ============
echo ""
echo ">>> [5/5] Starting training (augmented data)..."
echo "    Model:  Qwen/Qwen3.5-4B"
echo "    Output: $OUTPUT_DIR"

bash "$SCRIPT_DIR/train_swift_4b_aug.sh"
