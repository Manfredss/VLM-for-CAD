#!/bin/bash
# ================================================================
# Qwen3.5-27B ms-swift LoRA training — Siemens 7-feature dataset
# (silver plating / bending, revised prompt v3)
#
# Key settings:
#   - 7 categories (no Group class)
#   - max_length=6144
#   - LoRA rank=32 all-linear
#   - DeepSpeed Zero-3
#   - Hierarchical LR: ViT 1e-5, Aligner 2e-5, LLM 2e-5
#   - Unlocked ViT + Aligner
#
# Usage (on training pod):
#   TRAIN_CUDA_VISIBLE_DEVICES=0,1 bash /workspace/scripts/qwn3.5-27b_788_silver_plate_bend/train_swift.sh
# ================================================================
...
TRAIN_DATASET="${TRAIN_DATASET:-/workspace/data/train_7feats.jsonl}"
VAL_DATASET="${VAL_DATASET:-/workspace/data/val_7feats.jsonl}"
OUTPUT_DIR="${OUTPUT_DIR:-/workspace/output/swift_27b_7feats_silver_bend}"
...
JANITOR_LOG="${JANITOR_LOG:-/workspace/logs/keep_best_n_ckpts.log}"
JANITOR_PID=""
_stop_janitor() {
...
echo ">>> ===== Siemens 7-Feature Training (silver plating / bending) ====="
